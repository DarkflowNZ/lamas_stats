local translations = {
	["English"] = {
		...
		lamas_stats_perks_gamble = "Perks granted if picked:",
		...
		lamas_stats_projectiles_shot = "Projectiles shot:",
		...
		Shops = "Shops",
		show_shops_menu = "Show shops",
		shops_wand = "Wand",
		shops_sale = "Sale",
		shops_no_data = "No data",
	...
	["русский"] = {
		...
		lamas_stats_perks_gamble = "Перки при выборе:",
		...
		Shops = "Магазины",
		show_shops_menu = "Показывать магазины",
		shops_wand = "Палочка",
		shops_sale = "Скидка",
		shops_no_data = "Нет данных",
	...
	["日本語"] = {
		...
		lamas_stats_perks_gamble = "取得時に獲得するパーク:",
